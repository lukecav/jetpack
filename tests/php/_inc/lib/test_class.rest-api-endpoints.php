...
class WP_Test_Jetpack_REST_API_endpoints extends WP_UnitTestCase {
	...
	public function test_connection_permission() {
		...
		$this->assertTrue( Jetpack_Core_Json_Api_Endpoints::connect_url_permission_callback(), true );
		$this->assertTrue( Jetpack_Core_Json_Api_Endpoints::link_user_permission_callback(), true );
		$this->assertTrue( Jetpack_Core_Json_Api_Endpoints::get_user_connection_data_permission_callback(), true );
	...
	public function test_disconnection_permission() {
		...
		// User has capability so this should work this time
		$this->assertTrue( Jetpack_Core_Json_Api_Endpoints::disconnect_site_permission_callback(), true );
